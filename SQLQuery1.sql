...
ALTER TABLE GAME
ADD CONSTRAINT GAME_PUB_DATE DEFAULT GETDATE() FOR PUB_DATE;
...
BEGIN
	...
	VALUES
	(@DEV_ID, @GAME_TITLE, @GAME_DESC, 'https://via.placeholder.com/250x140?text=Not+Found', @PRICE)
END
...
BEGIN
	UPDATE STORE_USER
	SET EMAIL=@EMAIL, FNAME=@FNAME, LNAME=@LNAME, DATE_OF_BIRTH=@DATE_OF_BIRTH, BIO=@BIO
...
VALUES
('ADMIN','vicbbbb@proton.me','test','testadmin','z','b','','','','2004-12-01')
...
SELECT * FROM STORE_USER
DELETE FROM STORE_USER WHERE USER_ID = 8
