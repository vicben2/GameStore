...
--USER LOGIN PERMISSION STUFF
CREATE LOGIN readwriteuser WITH PASSWORD = 'admin1'

USE GAMESTOREDB
CREATE USER readwriteuser FOR LOGIN readwriteuser

GRANT SELECT ON SCHEMA::dbo TO readwriteuser
GRANT INSERT ON SCHEMA::dbo TO readwriteuser
GRANT DELETE ON SCHEMA::dbo TO readwriteuser

DENY ALTER ON DATABASE::GAMESTOREDB TO readwriteuser
DENY ALTER ON SCHEMA::dbo TO readwriteuser